...
DECLARE_CLASS_CODEGEN(CustomJSONData::v2, CustomBeatmapSaveData_NoteData, BeatmapSaveDataVersion2_6_0AndEarlier::BeatmapSaveData::NoteData,
    DECLARE_FASTER_CTOR(ctor, float time, int lineIndex, GlobalNamespace::NoteLineLayer lineLayer, BeatmapSaveDataVersion2_6_0AndEarlier::BeatmapSaveData::NoteType type, GlobalNamespace::NoteCutDirection cutDirection);
...
DECLARE_CLASS_CODEGEN(CustomJSONData::v2, CustomBeatmapSaveData_ObstacleData, BeatmapSaveDataVersion2_6_0AndEarlier::BeatmapSaveData::ObstacleData,
    DECLARE_FASTER_CTOR(ctor, float time, int lineIndex, BeatmapSaveDataVersion2_6_0AndEarlier::BeatmapSaveData::ObstacleType type, float duration, int width);
...
DECLARE_CLASS_CODEGEN(CustomJSONData::v2, CustomBeatmapSaveData_EventData, BeatmapSaveDataVersion2_6_0AndEarlier::BeatmapSaveData::EventData,
    DECLARE_FASTER_CTOR(ctor, float time, BeatmapSaveDataVersion2_6_0AndEarlier::BeatmapSaveData::BeatmapEventType type, int value, float floatValue);
