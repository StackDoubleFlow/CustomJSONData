...
constexpr auto&
LightColorBaseData_GetTransitionType(BeatmapSaveDataVersion3::BeatmapSaveData::LightColorBaseData const* item) {
  return item->i;
}

constexpr auto&
LightColorBaseData_GetColorType(BeatmapSaveDataVersion3::BeatmapSaveData::LightColorBaseData const* item) {
  return item->c;
}

constexpr auto&
LightColorBaseData_GetBrightness(BeatmapSaveDataVersion3::BeatmapSaveData::LightColorBaseData const* item) {
  return item->s;
}

constexpr auto&
LightColorBaseData_GetStrobeFrequency(BeatmapSaveDataVersion3::BeatmapSaveData::LightColorBaseData const* item) {
  return item->f;
}
...
constexpr auto
LightRotationBaseData_GetStrobeFrequency(BeatmapSaveDataVersion3::BeatmapSaveData::LightRotationBaseData const* item) {
  return item->p == 1;
}

constexpr auto&
LightRotationBaseData_GetRotation(BeatmapSaveDataVersion3::BeatmapSaveData::LightRotationBaseData const* item) {
  return item->r;
}

constexpr auto&
LightRotationBaseData_GetLoopsCount(BeatmapSaveDataVersion3::BeatmapSaveData::LightRotationBaseData const* item) {
  return item->l;
}
