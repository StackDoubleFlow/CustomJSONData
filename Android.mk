...
# Creating prebuilt for dependency: beatsaber-hook - version: 2.1.3
include $(CLEAR_VARS)
LOCAL_MODULE := beatsaber-hook_2_1_3
LOCAL_EXPORT_C_INCLUDES := extern/beatsaber-hook
LOCAL_SRC_FILES := extern/libbeatsaber-hook_2_1_3.so
LOCAL_CPP_FEATURES += exceptions
include $(PREBUILT_SHARED_LIBRARY)
# Creating prebuilt for dependency: codegen - version: 0.11.0
include $(CLEAR_VARS)
LOCAL_MODULE := codegen_0_11_0
LOCAL_EXPORT_C_INCLUDES := extern/codegen
LOCAL_SRC_FILES := extern/libcodegen_0_11_0.so
LOCAL_CPP_FEATURES += exceptions
include $(PREBUILT_SHARED_LIBRARY)
...
LOCAL_SHARED_LIBRARIES += beatsaber-hook_2_1_3
LOCAL_SHARED_LIBRARIES += codegen_0_11_0
